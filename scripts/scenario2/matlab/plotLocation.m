function [] = plotLocation()
    ...
    for s=1:numOfSimulations
        ...
        for i=startOfMobileDeviceLoop:stepOfMobileDeviceLoop:endOfMobileDeviceLoop
            try
                filePath = strcat(folderPath,'/ite',int2str(s),'/SIMRESULT_DEFAULT_SCENARIO_EDGE_UTIL_HEURISTIC_',int2str(i),'DEVICES_LOCATION.log');
    ...
    h.Title = 'Mean number of clients per places';
    h.XLabel = 'Place IDs';
    h.YLabel = '# of Clients in simulation';
