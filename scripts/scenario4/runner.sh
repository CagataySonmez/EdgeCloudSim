...
java -classpath "../../bin${SEP}../../lib/cloudsim-4.0.jar${SEP}../../lib/commons-math3-3.6.1.jar${SEP}../../lib/colt.jar" edu.boun.edgecloudsim.applications.scenario4.MainApp $scenario_conf_file $scenario_edge_devices_file $scenario_applications_file $scenario_out_folder $iteration_number > ${scenario_out_folder}.log
