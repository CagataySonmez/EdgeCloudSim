...
package edu.boun.edgecloudsim.applications.motivation2;
...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/motivation2/config/default_config.properties";
			applicationsFile = "scripts/motivation2/config/applications.xml";
			edgeDevicesFile = "scripts/motivation2/config/edge_devices.xml";
