...
public class FuzzyMobileServerManager extends MobileServerManager {
	private int numOfMobileDevices = 0;

	public FuzzyMobileServerManager(int _numOfMobileDevices) {
	...
	public void createVmList(int brokerId) {
		...
		for (int i = 0; i < numOfMobileDevices; i++) {
			...
			// VM Parameters
			MobileVM vm = new MobileVM(vmCounter, brokerId, mips, numOfCores, ram, bandwidth, storage, vmm,
